...
//􀑻􂫳􁓴􀏝􄖭􀏾􀨬􁎹
        ...
        zhangSan.setSex(VisitorPattern_18.three.Employee.MALE);
...
//􀑻􂫳􁴢􀲯􄖭􀏾􀨬􁎹
        ...
        liSi.setName("lisi");
        liSi.setSalary(1900);
        liSi.setSex(VisitorPattern_18.three.Employee.FEMALE);
        empList.add(liSi);
        Manager wangWu = new Manager();
        wangWu.setName("wangwu");
        wangWu.setPerformance("􀷎fuzhi;;;;");
        wangWu.setSalary(18750);
        wangWu.setSex(VisitorPattern_18.three.Employee.MALE);
        empList.add(wangWu);
        return empList;
    }
}
